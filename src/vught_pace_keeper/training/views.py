...
from .forms import PlanWizardStep1Form, PlanWizardStep2Form, WorkoutEditForm
from .generators import PlanGeneratorRegistry
from .generators.base import PlanConfig
from .models import ScheduledWorkout, TrainingPlan, TrainingWeek
...
def plan_detail(request, pk):
    ...
    plan = get_object_or_404(
        TrainingPlan.objects.prefetch_related("weeks__scheduled_workouts"),
        pk=pk,
    )
